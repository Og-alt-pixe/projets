...
const PROJECTS_DATA = [
    {
        id: "volatiles-paris",
        title: "L'empreinte \nd'un geste",
        category: "événement signature",
        displayCategory: "événement artisanal",
        year: "2025",
...
`,
        ...
        gallery: [
            ...
            { src: "image/2025-giro-mains-cave-large.png", layout: "" },
            { src: "image/volatiles0.webp", layout: "portrait" },
            { src: "image/raisin.webp", layout: "square" },
            { src: "image/2025-verre-raisin-couleur-anim-semilarge.png", layout: "" },
    ...
    //------------CARAFE-------------->
    {
        ...
        category: "artisanat",
        displayCategory: "Gravure sur cristal",
        year: "2025",
        type: "Artisanat",
        discipline: "Design & Artisanat",
        ...
        gallery: [
            ...
            { src: "image/client-logo(1).webp", layout: "" },
            { src: "image/client-calli(2).webp", layout: "square" }
        ]
    },
    ...
    {
        id: "perso",
        title: "Design, Motifs & Gravure",
        category: "artisanat",
        displayCategory: "Design & Artisanat",
        year: "depuis 2024",
        type: "Artisanat",
    ...
    {
        id: "lvmh",
        title: "Gravure à Paris",
        category: "artisanat",
        displayCategory: "Prestation artisanale",
        year: "depuis 2029",
        ...
        imageNext: "",
        url: "projet-page.html?id=lvmh",
        gallery: [
            { src: "image/anim-baton(1).webp", layout: "" },
            { src: "image/home/anim-calli(1).webp", layout: "" },
            { src: "image/anim-calli(2).webp", layout: "portrait" }
